...
export function RagBeam({ className }: { className?: string }) {
    ...
    >
      <div className="flex flex-wrap w-full max-w-lg flex-row items-stretch justify-between gap-6 md:gap-10">
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={pdfRef} className="w-12 h-12 md:w-16 md:h-16">
            <Icons.pdf />
          </Circle>
          <Circle ref={googleDocsRef} className="w-12 h-12 md:w-16 md:h-16">
            <Icons.googleDocs />
          </Circle>
          <Circle ref={notionRef} className="w-12 h-12 md:w-16 md:h-16">
            <Icons.notion />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={openaiRef} className="w-16 h-16 md:w-20 md:h-20">
            <Icons.openai />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={userRef} className="w-12 h-12 md:w-16 md:h-16">
            <Icons.user />
          </Circle>
        </div>
      </div>
      ...
      {/* Animated Beams */}
      <AnimatedBeam containerRef={containerRef} fromRef={pdfRef} toRef={openaiRef} />
      <AnimatedBeam containerRef={containerRef} fromRef={googleDocsRef} toRef={openaiRef} />
      <AnimatedBeam containerRef={containerRef} fromRef={notionRef} toRef={openaiRef} />
      <AnimatedBeam containerRef={containerRef} fromRef={openaiRef} toRef={userRef} />
    </div>
  );
}
...
const Icons = {
  ...
  >
    ...
    <path
      ...
      d="M39,16v25c0,1.1-0.9,2-2,2H11c-1.1,0-2-0.9-2-2V7c0-1.1,0.9-2,2-2h19l9,9V16z"
    />
    <path
      fill="#FFE0E0"
      d="M30,7v7c0,1.1,0.9,2,2,2h7L30,7z"
    />
    <path
      fill="#FFFFFF"
      d="M24.7,21h-3.4v9h1.7v-3h1.7c1.8,0,3.3-1.5,3.3-3S26.5,21,24.7,21z M24.7,25h-1.7v-2h1.7 c0.6,0,1,0.4,1,1S25.3,25,24.7,25z M31.3,21H28v9h3.3c2.5,0,4.7-2,4.7-4.5S33.8,21,31.3,21z M31.3,28H29.7v-5h1.7 c1.4,0,2.7,1.1,2.7,2.5S32.7,28,31.3,28z M16.7,21H14v9h2.7c1.8,0,3.3-1.5,3.3-3v-3C20,22.5,18.5,21,16.7,21z M18.3,27 c0,0.6-0.4,1-1,1H15.7v-5H17c0.6,0,1,0.4,1,1V27z"
    />
  </svg>
),
gemini: () => (
  ...
  >
    ...
    <path
      fill="#FFFFFF"
      d="M33,16.5c0,0.83-0.67,1.5-1.5,1.5S30,17.33,30,16.5s0.67-1.5,1.5-1.5S33,15.67,33,16.5z M21,19v10 c0,1.66-1.34,3-3,3s-3-1.34-3-3V19h-2v10c0,2.76,2.24,5,5,5s5-2.24,5-5V19H21z M30,19v10c0,1.66-1.34,3-3,3s-3-1.34-3-3V19h-2v10 c0,2.76,2.24,5,5,5s5-2.24,5-5V19H30z"
    />
  </svg>
)

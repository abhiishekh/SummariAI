...
export async function HeroSection() {
  return (
    <div className="w-full bg-transparent z-10">
      <Background />
<div className="relative mt-[-36px] w-[87%] md:w-[96%] bg-white dark:bg-black overflow-visible rounded-t-sm m-auto p-3 border-l border-r border-stone-950/10 dark:border-stone-50/20 shadow-2xl shadow-black">
  <div
  ...
  <DemoSection />
      ...
      <div className="relative min-h-screen w-full bg-white dark:bg-black border-t border-stone-50/10 dark:border-stone-50/20 overflow-hidden">
        <div

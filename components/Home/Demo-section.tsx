            ...
            <div className="flex flex-col items-center text-c
             space-y-4">
                ...
                <h3 className="text-3xl font-bold max-w-2xl mx-auto px-4 sm:px-6">
                    Watch How Brainwave transforms this <span className=" bg-linear-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">Next.js course PDF </span>into an easy-to-read summary!
                </h3>
                </div>
